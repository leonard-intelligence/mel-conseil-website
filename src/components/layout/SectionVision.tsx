import { ArrowUpRight, Video, ScanFace } from 'lucide-react';
    ...
    return (
        <section id="section-expertise-vision" className="max-w-[1400px] mx-auto border-t border-x border-b border-white/10 bg-black" aria-labelledby="expertise-vision-heading">
            <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[600px]">
                ...
                <div className="lg:col-span-8 border-r border-white/10 relative p-12 flex flex-col justify-between overflow-hidden">

                    {/* Header Area */}
                    <div className="relative z-10 mb-12">
                        <div className="text-blue-500 font-mono mb-2 text-lg">01 Visual Intelligence.</div>
                        <h2 id="expertise-vision-heading" className="text-4xl md:text-5xl font-mono text-white max-w-4xl leading-tight uppercase tracking-[-0.02em]">
                            Pour la logistique, la qualité<br />
                            <span className="text-muted-foreground">et le marketing visuel.</span>
                        </h2>
                    </div>
                    ...
                    <div className="mt-auto relative z-10">
                        <div id="expertise-vision-card" className="max-w-lg border border-white/20 bg-black/60 backdrop-blur-md rounded transition-colors p-6 group">
                            ...
                            <div className="flex justify-between items-start mb-4">
                                <h3 className="text-xl text-white font-mono uppercase tracking-[-0.02em]">Computer Vision & Gen-AI</h3>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-2 text-[10px] font-mono text-zinc-500 bg-white/5 p-3 rounded border border-white/5">
                                <div className="flex justify-between"><span>TYPE</span><span className="text-white">VISION+GEN</span></div>
                                <div className="flex justify-between"><span>MODELS</span><span className="text-blue-400">SOTA</span></div>
                ...
                <div className="lg:col-span-4 flex flex-col">
                    ...
                    <div className="flex-1 flex flex-col">
                        <div id="expertise-vision-item-1" className="flex-1 border-b border-white/10 p-8 group hover:bg-white/5 transition-colors cursor-pointer relative">
                        ...
                        <div id="expertise-vision-item-2" className="flex-1 p-8 group hover:bg-white/5 transition-colors cursor-pointer relative">
                            <ArrowUpRight className="absolute top-8 right-8 text-white w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="w-8 h-8 bg-black border border-white/10 flex items-center justify-center mb-4 text-white bg-[repeating-linear-gradient(45deg,rgba(255,255,255,0.03),rgba(255,255,255,0.03)_1px,transparent_1px,transparent_8px)]">
                                <Video className="w-4 h-4" />
                            </div>
                            <h3 className="text-white font-mono text-lg mb-2 uppercase tracking-[-0.02em]">Gen-AI Image & Video</h3>

...
export function Contact() {
    ...
    return (
        <section id="section-contact" className="py-24 bg-black relative border-t border-white/10">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">

                {/* Contact Info */}
                <div>
                    <h2 id="contact-heading" className="text-4xl md:text-5xl font-bold font-mono uppercase text-white mb-6">
                        Parlons de <span className="text-blue-500">votre projet.</span>
                    </h2>
                        ...
                        <form id="contact-form" onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <Input id="firstName" placeholder="JEAN" required className="bg-white/5 border-white/10 text-white placeholder:text-gray-600 focus:border-blue-500 rounded-none h-12 font-mono" />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="name" className="text-gray-300 font-mono uppercase text-xs">Nom</Label>
                                    <Input id="name" placeholder="DUPONT" required className="bg-white/5 border-white/10 text-white placeholder:text-gray-600 focus:border-blue-500 rounded-none h-12 font-mono" />
                                </div>
                            </div>

                            <div className="space-y-2">
                                <Label htmlFor="email" className="text-gray-300 font-mono uppercase text-xs">Email professionnel</Label>
                                <Input id="email" type="email" placeholder="JEAN.DUPONT@ENTREPRISE.COM" required className="bg-white/5 border-white/10 text-white placeholder:text-gray-600 focus:border-blue-500 rounded-none h-12 font-mono" />
                            </div>

                            <div className="space-y-2">
                                <Label htmlFor="company" className="text-gray-300 font-mono uppercase text-xs">Entreprise</Label>
                                <Input id="company" placeholder="VOTRE SOCIÉTÉ" className="bg-white/5 border-white/10 text-white placeholder:text-gray-600 focus:border-blue-500 rounded-none h-12 font-mono" />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    className="min-h-[120px] bg-white/5 border-white/10 text-white placeholder:text-gray-600 focus:border-blue-500 rounded-none font-mono"
                                    required
                                />
                            </div>

            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col mb-16">
                    <div className="reveal-up mb-12">
                        <div className="absolute -inset-4 bg-[#e67d23]/10 blur-3xl -z-10 rounded-full opacity-50" aria-hidden="true" />
                        <span className="text-[#e67d23] text-sm tracking-widest uppercase mb-4 block flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-3 gap-2 md:gap-8 relative">
                        ...
                        <div className="absolute top-3 md:top-7 left-0 right-0 h-10 z-0 pointer-events-none">
                            {/* Line */}
                            <div className="absolute top-1/2 left-[12%] right-[12%] md:left-[16%] md:right-[16%] h-[2px] -translate-y-1/2 bg-gradient-to-r from-[#e67d23]/20 via-[#e67d23]/50 to-[#e67d23]/20"></div>

                            {/* Arrow 1 (Between 1 & 2) */}
                            <div className="absolute top-1/2 left-1/3 -translate-y-1/2 -translate-x-1/2 bg-black px-1 md:px-3">
                                <DotIcon icon={leonardIcons.arrowRight || "arrow-right"} className="w-4 h-4 md:w-5 md:h-5" fillColor="#e67d23" />
                            </div>
                        ...
                        <div className="group relative z-10 flex flex-col items-center text-center">
                            <div className="w-16 h-16 md:w-24 md:h-24 bg-[#121110] border border-white/10 rounded-full flex items-center justify-center mb-3 md:mb-6 group-hover:border-[#e67d23]/50 group-hover:bg-[#121110] transition-all duration-500 relative">
                                <div className="absolute inset-0 bg-[#e67d23]/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-full"></div>
                                <div className="scale-75 md:scale-100 transform transition-transform">
                                    <DotIcon icon={leonardIcons.search} size={32} fillColor="#e67d23" />
                                </div>
                                <div className="absolute -top-1 -right-1 md:-top-2 md:-right-2 w-6 h-6 md:w-8 md:h-8 rounded-full bg-[#1A1918] border border-white/10 flex items-center justify-center text-[#e67d23] font-mono text-xs md:text-sm font-bold shadow-lg shadow-black/50">1</div>
                            </div>
                            <h3 className="text-xs md:text-xl font-mono text-white uppercase mb-1 md:mb-2 group-hover:text-[#e67d23] transition-colors leading-tight">AUDIT</h3>
                            <span className="text-[#e67d23] text-[10px] md:text-xs font-mono mb-2 md:mb-3 py-0.5 px-1 md:py-1 md:px-2 bg-[#e67d23]/10 rounded border border-[#e67d23]/20 whitespace-nowrap">Semaine 1-2</span>
                        ...
                        <div className="group relative z-10 flex flex-col items-center text-center">
                            <div className="w-16 h-16 md:w-24 md:h-24 bg-[#121110] border border-white/10 rounded-full flex items-center justify-center mb-3 md:mb-6 group-hover:border-[#e67d23]/50 group-hover:bg-[#121110] transition-all duration-500 relative">
                                <div className="absolute inset-0 bg-[#e67d23]/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-full"></div>
                                <div className="scale-75 md:scale-100 transform transition-transform">
                                    <DotIcon icon={leonardIcons.workflows} size={32} fillColor="#e67d23" />
                                </div>
                                <div className="absolute -top-1 -right-1 md:-top-2 md:-right-2 w-6 h-6 md:w-8 md:h-8 rounded-full bg-[#1A1918] border border-white/10 flex items-center justify-center text-[#e67d23] font-mono text-xs md:text-sm font-bold shadow-lg shadow-black/50">2</div>
                            </div>
                            <h3 className="text-xs md:text-xl font-mono text-white uppercase mb-1 md:mb-2 group-hover:text-[#e67d23] transition-colors leading-tight">Prototype</h3>
                            <span className="text-[#e67d23] text-[10px] md:text-xs font-mono mb-2 md:mb-3 py-0.5 px-1 md:py-1 md:px-2 bg-[#e67d23]/10 rounded border border-[#e67d23]/20 whitespace-nowrap">Semaine 3-5</span>
                        ...
                        <div className="group relative z-10 flex flex-col items-center text-center">
                            <div className="w-16 h-16 md:w-24 md:h-24 bg-[#121110] border border-white/10 rounded-full flex items-center justify-center mb-3 md:mb-6 group-hover:border-[#e67d23]/50 group-hover:bg-[#121110] transition-all duration-500 relative">
                                <div className="absolute inset-0 bg-[#e67d23]/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-full"></div>
                                <div className="scale-75 md:scale-100 transform transition-transform">
                                    <DotIcon icon={leonardIcons.building} size={32} fillColor="#e67d23" />
                                </div>
                                <div className="absolute -top-1 -right-1 md:-top-2 md:-right-2 w-6 h-6 md:w-8 md:h-8 rounded-full bg-[#1A1918] border border-white/10 flex items-center justify-center text-[#e67d23] font-mono text-xs md:text-sm font-bold shadow-lg shadow-black/50">3</div>
                            </div>
                            <h3 className="text-xs md:text-xl font-mono text-white uppercase mb-1 md:mb-2 group-hover:text-[#e67d23] transition-colors leading-tight">Production</h3>
                            <span className="text-[#e67d23] text-[10px] md:text-xs font-mono mb-2 md:mb-3 py-0.5 px-1 md:py-1 md:px-2 bg-[#e67d23]/10 rounded border border-[#e67d23]/20 whitespace-nowrap">Semaine 6-8</span>
                    ...
                    <div className="bg-[#121110]/80 backdrop-blur-md border border-white/10 rounded-full p-1 flex gap-1">
                        <button
                            ...
                            className={cn(
                                ...
                                activeTab === 'sovereign'
                                    ? "bg-[#e67d23] text-black font-bold shadow-[0_0_20px_rgba(230,126,34,0.3)]"
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 overflow-hidden min-h-[420px]">
                            ...
                            <div className="lg:col-span-7 relative border-r border-white/10 bg-[#121110]/20 p-12 flex flex-col justify-center group overflow-hidden">
                                ...
                                <div className="relative z-10 w-full">
                                    <div className="font-mono text-sm flex items-center gap-4 mb-6 text-[#e67d23]">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 border-t border-white/10 bg-black/50">
                            {MODEL_DATA[displayedTab].categories.map((card, i) => (
                                ...
                                >
                                    <div className="w-8 h-8 rounded mb-4 flex items-center justify-center transition-transform duration-300 group-hover/card:scale-110 text-[#e67d23] bg-[#e67d23]/10">
                                        <DotIcon icon={card.icon} size={16} fillColor="#e67d23" />
                                    </div>
                                    <h4 className="font-mono text-xs uppercase tracking-wider mb-3 transition-colors text-zinc-300 group-hover/card:text-[#e67d23]">
                                        {card.title}
                                    </h4>

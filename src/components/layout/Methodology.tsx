            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col mb-16">
                    ...
                    <div className="grid grid-cols-3 gap-2 md:gap-8 relative">
                        ...
                        <div className="absolute top-6 md:top-12 left-0 right-0 h-10 z-0 pointer-events-none">
                            {/* Line */}
                            ...
                            <div className="absolute top-1/2 left-1/3 -translate-y-1/2 -translate-x-1/2 bg-black px-1 md:px-3">
                                <DotIcon icon={leonardIcons.arrowRight || "arrow-right"} className="w-3 h-3 md:w-5 md:h-5" fillColor="#E67E22" />
                            </div>
                        ...
                        <div className="group relative z-10 flex flex-col items-center text-center">
                            <div className="w-12 h-12 md:w-24 md:h-24 bg-[#121110] border border-white/10 rounded-full flex items-center justify-center mb-3 md:mb-6 group-hover:border-[#E67E22]/50 group-hover:bg-[#121110] transition-all duration-500 relative">
                                ...
                                <div className="scale-50 md:scale-100 transform transition-transform">
                                    <DotIcon icon={leonardIcons.search} size={32} fillColor="#E67E22" />
                                </div>
                                <div className="absolute -top-1 -right-1 md:-top-2 md:-right-2 w-5 h-5 md:w-8 md:h-8 rounded-full bg-[#1A1918] border border-white/10 flex items-center justify-center text-[#E67E22] font-mono text-[10px] md:text-sm font-bold shadow-lg shadow-black/50">1</div>
                            </div>
                            <h3 className="text-[10px] md:text-xl font-mono text-white uppercase mb-1 md:mb-2 group-hover:text-[#E67E22] transition-colors leading-tight">AUDIT</h3>
                            <span className="text-[#E67E22] text-[8px] md:text-xs font-mono mb-2 md:mb-3 py-0.5 px-1 md:py-1 md:px-2 bg-[#E67E22]/10 rounded border border-[#E67E22]/20 whitespace-nowrap">Semaine 1-2</span>
                            <p className="text-zinc-400 text-[9px] md:text-sm max-w-[240px] leading-tight hidden md:block">On identifie vos cas d'usage à fort ROI. Vous voyez les <span className="text-white">premiers résultats</span>.</p>
                            <p className="text-zinc-400 text-[9px] leading-tight block md:hidden">Cas d'usage à fort ROI.</p>
                        </div>
                        ...
                        <div className="group relative z-10 flex flex-col items-center text-center">
                            <div className="w-12 h-12 md:w-24 md:h-24 bg-[#121110] border border-white/10 rounded-full flex items-center justify-center mb-3 md:mb-6 group-hover:border-[#E67E22]/50 group-hover:bg-[#121110] transition-all duration-500 relative">
                                ...
                                <div className="absolute -top-1 -right-1 md:-top-2 md:-right-2 w-5 h-5 md:w-8 md:h-8 rounded-full bg-[#1A1918] border border-white/10 flex items-center justify-center text-[#E67E22] font-mono text-[10px] md:text-sm font-bold shadow-lg shadow-black/50">2</div>
                            </div>
                            <h3 className="text-[10px] md:text-xl font-mono text-white uppercase mb-1 md:mb-2 group-hover:text-[#E67E22] transition-colors leading-tight">Prototype</h3>
                            <span className="text-[#E67E22] text-[8px] md:text-xs font-mono mb-2 md:mb-3 py-0.5 px-1 md:py-1 md:px-2 bg-[#E67E22]/10 rounded border border-[#E67E22]/20 whitespace-nowrap">Semaine 3-5</span>
                            <p className="text-zinc-400 text-[9px] md:text-sm max-w-[240px] leading-tight hidden md:block">Un agent fonctionnel, sur vos données, <span className="text-white">intégré à vos outils</span>.</p>
                            <p className="text-zinc-400 text-[9px] leading-tight block md:hidden">Agent fonctionnel intégré.</p>
                        </div>
                        ...
                        <div className="group relative z-10 flex flex-col items-center text-center">
                            <div className="w-12 h-12 md:w-24 md:h-24 bg-[#121110] border border-white/10 rounded-full flex items-center justify-center mb-3 md:mb-6 group-hover:border-[#E67E22]/50 group-hover:bg-[#121110] transition-all duration-500 relative">
                                ...
                                <div className="absolute -top-1 -right-1 md:-top-2 md:-right-2 w-5 h-5 md:w-8 md:h-8 rounded-full bg-[#1A1918] border border-white/10 flex items-center justify-center text-[#E67E22] font-mono text-[10px] md:text-sm font-bold shadow-lg shadow-black/50">3</div>
                            </div>
                            <h3 className="text-[10px] md:text-xl font-mono text-white uppercase mb-1 md:mb-2 group-hover:text-[#E67E22] transition-colors leading-tight">Production</h3>
                            <span className="text-[#E67E22] text-[8px] md:text-xs font-mono mb-2 md:mb-3 py-0.5 px-1 md:py-1 md:px-2 bg-[#E67E22]/10 rounded border border-[#E67E22]/20 whitespace-nowrap">Semaine 6-8</span>
                            <p className="text-zinc-400 text-[9px] md:text-sm max-w-[240px] leading-tight hidden md:block">Déploiement, formation des équipes, <span className="text-white">monitoring</span>.</p>
                            <p className="text-zinc-400 text-[9px] leading-tight block md:hidden">Déploiement & monitoring.</p>
                        </div>
                    </div>
                </div>

        ...
        >
            ...
            <div className="p-6 md:p-12 border-b border-white/10 reveal-up">
                ...
                >
                    ...
                    <span className="text-zinc-400">opérationnels immédiatement.</span>
                </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="text-xs font-mono text-zinc-400 uppercase tracking-wider">Charge admin</div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="text-xs font-mono text-zinc-400 uppercase tracking-wider">Productivité</div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="text-xs font-mono text-zinc-400 uppercase tracking-wider">ROI garanti</div>
                    </div>
                </div>

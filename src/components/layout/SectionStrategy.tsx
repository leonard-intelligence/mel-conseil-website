    ...
    return (
        ...
        >
            ...
            <div className="p-12 border-b border-white/10 text-center">
                <div className="text-blue-500 font-mono mb-2 text-lg">04 Avantage Concurrentiel.</div>
                <h2
                    id="strategy-heading"
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4">
                ...
                <div className="col-span-2 p-8 border-r border-white/10 bg-blue-500/5 flex items-center gap-8">
                    ...
                    <div className="text-center">
                        <div className="font-mono text-6xl font-bold text-blue-400 mb-1">80%</div>
                        <div className="text-xs font-mono text-blue-400 uppercase">2027</div>
                    </div>
                </div>
                ...
                <div className="col-span-2 lg:col-span-2 p-6 border-t border-r border-white/10">
                    ...
                    <div className="h-3 bg-white/10 rounded-full overflow-hidden">
                        <div className="h-full bg-gradient-to-r from-blue-500 via-blue-400 to-[#E67E22] w-[35%] rounded-full animate-pulse" />
                    </div>
                </div>

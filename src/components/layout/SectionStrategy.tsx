    ...
    return (
        ...
        >
            ...
            <div className="p-12 border-b border-white/10 text-center">
                <div className="text-[#E67E22] mb-2 text-lg">Avantage Concurrentiel.</div>
                <h2
                    id="strategy-heading"
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4">
                ...
                <div className="col-span-2 p-8 border-r border-white/10 bg-[#E67E22]/5 flex items-center gap-8">
                    ...
                    <div className="text-center">
                        <div className="text-6xl font-medium text-[#E67E22] mb-1">80%</div>
                        <div className="text-xs text-[#E67E22] uppercase">2027</div>
                    </div>
                </div>
                ...
                <div className="col-span-2 lg:col-span-2 p-6 border-t border-r border-white/10">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-xs text-[#E67E22]">18 mois</span>
                    </div>
